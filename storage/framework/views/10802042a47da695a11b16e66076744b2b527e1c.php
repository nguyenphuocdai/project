                ...
                <div class="span9">
                 <!-- Category-->
                  <section id="categorygrid">
                    ...
                    <?php $__currentLoopData = $price_500; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_price_500): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>                  
                      <li class="span3">
                        <a class="prdocutname" href="<?php echo e(url('chi-tiet-san-pham',[$item_price_500->product_id,$item_price_500->alias])); ?>"><?php echo e($item_price_500->name); ?></a>
                        <div class="thumbnail">
                          <span class="sale tooltip-test">Sale</span>
                          <a href="#"><img alt="" src="<?php echo e(asset('resources/upload/'.$item_price_500->image)); ?>"></a>
                          <div class="pricetag">
                            <span class="spiral"></span><a href="<?php echo e(url('mua-hang',[$item_price_500->product_id,$item_price_500->alias])); ?>" class="productcart">Thêm Vào Giỏ</a>
                            <div class="price">
                              <div class="pricenew"><?php echo e(number_format($item_price_500->price,0,",",".")); ?></div>
                              <div class="priceold"><?php echo e(number_format($item_price_500->price*1.2,0,",",".")); ?></div>
                            </div>
                          </div>
                        </div>
                      </li>
