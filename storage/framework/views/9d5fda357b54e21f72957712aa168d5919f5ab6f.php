                ...
                <fieldset>
                  <div class="span4">
                    <div class="control-group">
                      <a href="<?php echo e(url('dang-nhap-khach-hang')); ?>"><label class="control-label" ><?php if(Auth::guard('customers')->user())
                      echo "";
                      else 
                      ...
                      <!--<div class="controls">
                        <input type="text" class=""  value="<?php echo e(old('txtUsername')); ?>" name="txtUsername" >
                      </div>-->
                    </div>
                    <div class="control-group">
                      <!--<label class="control-label"  >Mật khẩu: <span class="red">*</span></label>-->
                      <!--<div class="controls">
                        <input type="text" class=""  value="<?php echo e(old('txtPassword')); ?>" name="txtPassword" >
                      </div>-->
                    </div>
                  </div>
                  <!--chưa cần dùng-->
                  <div class="span4">
                    <div class="control-group">
                      <a href="<?php echo e(url('dang-ky-khach-hang')); ?>"><label class="control-label" >
                      <?php if(Auth::guard('customers')->user())
                      echo "";
                      else 
            ...
            <div class="cart-info">
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  ...
                  <td class="quantity"><input type="text" size="1" value="<?php echo e($item_content->qty); ?>" disabled="" name="quantity[40]" class="span1">
                    &nbsp;  
