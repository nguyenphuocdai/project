	...
	<div class="eight columns" >
		<div class="slider-padding">
			<div id="product-slider" class="">
				<?php $__currentLoopData = $img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="eight columns">
		<div class="product-page">
			...
			<section class="title">
				...
				<span class="product-price-discount"><i><?php echo e(number_format($pr_detail->price,0,",",".")); ?></i></span>
				<div class="reviews-counter">
					<span style="margin-top: 12px;">Lượt xem</span>
					<span style="text-align: center;color: olivedrab;margin-top: 20px;"><?php echo e($display_view->view); ?></span>
				</div>
			</section>
			<!-- Text Parapgraph -->
			<section>
			...
			<div class="tab-content" id="tab3">
				...
				<section class="comments">
					<ul>
						...
						<?php $__currentLoopData = $t; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tcm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<li>
...
<div class="products">
<!-- Product #1 -->
<?php $__currentLoopData = $pr_relate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
