...
<?php $__currentLoopData = $sortPriceSmall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_pr_cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<div style="position: absolute;bottom: 0;left: 48%;"><?php echo e($sortPriceSmall->links()); ?></div>
