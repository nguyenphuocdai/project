  ...
  <section id="product">
    <div class="container">
     <!--  breadcrumb --> 
      <ul class="breadcrumb">
        <li>
          <a href="<?php echo e(url('/')); ?>">Quay Lại Trang Chủ</a>
      </ul>
      <div class="row">        
        <!-- Register Account-->
        <div class="span9">
          ...
          <?php echo $__env->make('admin.danger.danger', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
            ...
            <div class="loginbox">
              ...
              <form class="form" method="post" action="<?php echo e(url('dang-ky-khach-hang')); ?>">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text"  class="span3" name="txtUsername" value="<?php echo e(old('txtUsername')); ?>"style="height: 30px;" placeholder="Viết liền không dấu">
                    </div>
                  </div>
                    <label  class="control-label">Họ và Tên: <i class="fa fa-times-circle" style="color: red"></i></label>
                    <div class="controls">
                      <input type="text"  class="span3" name="txtName" value="<?php echo e(old('txtName')); ?>" style="height: 30px;" placeholder="Nhập đẩy đủ họ tên">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text"  class="span3" name="txtEmail" value="<?php echo e(old('txtEmail')); ?>"style="height: 30px;" placeholder="Nhập email">
                    </div>
                  </div>
                  <div class="control-group">
                    <label  class="control-label" >Địa Chỉ: <i class="fa fa-times-circle" style="color: red"></i></label>
                    <div class="controls">
                      <input type="text"  class="span3" name="txtAddress" value="<?php echo e(old('txtAddress')); ?>"style="height: 30px;" placeholder="Nhập địa chỉ">
                    </div>
                  </div>
                   <div class="control-group">
                    <label  class="control-label" >Số Điện Thoại: <i class="fa fa-times-circle" style="color: red"></i></label>
                    <div class="controls">
                      <input type="text"  class="span3" name="txtPhone" value="<?php echo e(old('txtPhone')); ?>"style="height: 30px;" placeholder="Nhập số điện thoại">
                    </div>
                  </div>
