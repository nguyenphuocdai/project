	...
	<div class="four columns">
		...
		<div class="widget margin-top-0">
			...
			<div class="twelve columns" style="display: inline-flex;">
				...
				background-color: #eee;" href="<?php echo e(url('sortPrice')); ?>">Sắp xếp theo giá cao</a></div>
				<div ><a class="caption-btn" style="    margin-left: 20px;
				background-color: #eee;" href="<?php echo e(url('sortPriceSmall')); ?>">Sắp xếp theo giá thấp</a></div>
			</div>
			<!-- Products -->
