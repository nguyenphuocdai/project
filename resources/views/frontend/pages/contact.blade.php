          ...
          <form class="form-horizontal" action="{{url('lien-he')}}"  method="post">
            ...
            <fieldset>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text"  placeholder="Nhập tên anh/chị" id="name" value="{{old('txtName')}}" name="txtName">
                </div>
              </div>
              <div class="control-group">
                <label for="name" class="control-label">Email: <span class="">*</span></label>
                <div class="controls">
                  <input type="text"  class="" id="name" value="{{old('txtEmail')}}" placeholder="Nhập email dạng abc@example.com" name="txtEmail">
                </div>
              </div>
               <div class="control-group">
                <label for="name" class="control-label">Số Điện Thoại: <span class="">*</span></label>
                <div class="controls">
                  <input type="text"  class="" id="name" value="{{old('txtPhone')}}" name="txtPhone">
                </div>
              </div>
              <div class="control-group">
