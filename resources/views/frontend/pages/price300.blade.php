                ...
                <div class="span9">
                 <!-- Category-->
                  <section id="categorygrid">
                    ...
                    @foreach($price_300 as $item_price_300)                  
                      <li class="span3">
                        <a class="prdocutname" href="{{url('chi-tiet-san-pham',[$item_price_300->product_id,$item_price_300->alias])}}">{{$item_price_300->name}}</a>
                        <div class="thumbnail">
                          <span class="sale tooltip-test">Sale</span>
                          <a href="{{url('chi-tiet-san-pham',[$item_price_300->product_id,$item_price_300->alias])}}"><img alt="" src="{{ asset('resources/upload/'.$item_price_300->image)}}"></a>
                          <div class="pricetag">
                            <span class="spiral"></span><a href="{{url('mua-hang',[$item_price_300->product_id,$item_price_300->alias])}}" class="productcart">Thêm Vào Giỏ</a>
                            <div class="price">
                              <div class="pricenew">{{number_format($item_price_300->price,0,",",".") }}</div>
                              <div class="priceold">{{number_format($item_price_300->price*1.2,0,",",".") }}</div>
                            </div>
                          </div>
                        </div>
                      </li>
