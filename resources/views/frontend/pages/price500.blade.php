                ...
                <div class="span9">
                 <!-- Category-->
                  <section id="categorygrid">
                    ...
                    @foreach($price_500 as $item_price_500)                  
                      <li class="span3">
                        <a class="prdocutname" href="{{url('chi-tiet-san-pham',[$item_price_500->product_id,$item_price_500->alias])}}">{{$item_price_500->name}}</a>
                        <div class="thumbnail">
                          <span class="sale tooltip-test">Sale</span>
                          <a href="#"><img alt="" src="{{ asset('resources/upload/'.$item_price_500->image)}}"></a>
                          <div class="pricetag">
                            <span class="spiral"></span><a href="{{url('mua-hang',[$item_price_500->product_id,$item_price_500->alias])}}" class="productcart">Thêm Vào Giỏ</a>
                            <div class="price">
                              <div class="pricenew">{{number_format($item_price_500->price,0,",",".") }}</div>
                              <div class="priceold">{{number_format($item_price_500->price*1.2,0,",",".") }}</div>
                            </div>
                          </div>
                        </div>
                      </li>
