	...
	<form class="form-horizontal" role="form" action="{{ url('payment') }}" method="post">
		...
		<fieldset>
			...
			<div class="form-group" style="margin-top: 30px;">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" name="card_no" value="{{ old('card_no') }}" id="card_no" placeholder="Nhập số thẻ">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label" for="exp_month">Tháng expire</label>
				<div class="col-sm-4">
					<input type="text" id="exp_month" class="form-control" name="exp_month" value="{{ old('exp_year') }}" placeholder="Tháng hết hạn">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label" for="exp_year">Năm expire</label>
				<div class="col-sm-4">
					<input type="text" id="exp_year" class="form-control" name="exp_year" value="{{ old('exp_year') }}" placeholder="Năm hết hạn">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" name="cvv_no" id="cvv" value="{{ old('cvv_no') }}" placeholder="Mã bảo mật">
